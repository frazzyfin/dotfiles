# Generated by Powerlevel10k configuration wizard on 2020-08-26 at 22:16 BST.
...
# sharp heads, flat tails, 2 lines, disconnected, left frame, sparse, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%253F╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%253F├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%253F╰─'
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=253
